...
export default function NomineeCard() {
  ...
  const [formData, setFormData] = useState({
    ...
    nominee_age: user?.nominee_age?.toString() || "",
    nominee_contact: user?.nominee_contact || "",
    nominee_aadhaar: user?.nominee_aadhaar || "",
  });
          ...
          <div>
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                  {user.nominee_relationship || "Not Set"}
                </p>
              </div>
              <div>
                <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                  {maskAadhaar(user.nominee_aadhaar)}
                </p>
              </div>
            </div>
          </div>
