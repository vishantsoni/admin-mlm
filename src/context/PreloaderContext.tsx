...
export function PreloaderProvider({ children }: PreloaderProviderProps) {
    ...
    return (
        <PreloaderContext.Provider value={value}>
            {/* You can globally render your Loader component here based on isLoading */}
            {isLoading && (
                <div className="fixed inset-0 z-[999999] flex items-center justify-center bg-white">

                    <div role="status">
                        <svg aria-hidden="true" className="w-8 h-8 text-neutral-tertiary animate-spin fill-brand" viewBox="0 0 100 101" fill="#dd55a0" xmlns="http://www.w3.org/2000/svg">
